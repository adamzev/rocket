...
def edRow(big_G, V_vert_inc, time,totalWeight, totalA, V_horiz, V_as, A_v, A_h, V_vert, alt, thrust):
	print ("-"*120)
	print("+{:<18.2f} ALT={:.1f} T={:.4f}\n                                                          G={:.8f}\n{:<15.6f} \x1b[6;30;42m{:.1f}\x1b[0m WT={:<12.2f}->{:<20.6f} Vh= {:.2f} Vas {:.3f}          {:.6f}-{:.8f}".format(V_vert_inc, alt, thrust, big_G, V_vert, time,totalWeight, totalA, V_horiz, V_as, A_v, A_h))
