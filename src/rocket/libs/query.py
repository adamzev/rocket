...
class Query(object):
    ...
    # input_func gets subbed out in some tests
    input_func = input
    ...
    def query_min_max(cls, question, min_num=0.0, max_num=1.0):
        ...
        while True:
            ...
            if choice == "min" or choice == "max" or choice == "off":
                ...
                sys.stdout.write(
                    "Please respond with 'min', 'max', 'off' or a number between {} and {}. \n".format(
                        min_num, max_num
                    )
                )
    ...
    def query_from_list(
        ...
        while True:
            ...
            option_num = cls.query_int(
                "Select an {} number: ".format(list_name), None, 1, n
            )
            ...
            if 0 <= option_num < n:
                ...
                if len(results) >= min_selections:
                    ...
                    print(
                        "Please select at least {} {}s".format(
                            min_selections, list_name
                        )
                    )
            else:
