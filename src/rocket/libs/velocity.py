...
class Velocity(TwoD):
    def __init__(
        self, horiz, vert, earth_rotation_mph=912.67, vert_inc=0.0, horiz_inc=0.0
    ):
    ...
    def get_orbital(alt):
        ...
        Alt in feet
        """
        return equ.orbitalVelocity(alt)
    ...
    @property
    def horiz_mph(self):
        return equ.fpsToMph(self.horiz)

    @horiz_mph.setter
    def horiz_mph(self, value):
        self.horiz = equ.mphToFps(value)
    ...
    @property
    def vert_mph(self):
        return equ.fpsToMph(self.vert)

    @property
    def air_speed_mph(self):
        return equ.pythag(self.vert_mph, self.horiz_mph - self.earth_rotation_mph)

    @property
    def horiz_mph_inc(self):
        return equ.fpsToMph(self.horiz_inc)

    @horiz_mph_inc.setter
    def horiz_mph_inc(self, value):
        self._horiz_inc = equ.mphToFps(value)
